...
## Corpus Check
- 77 files · ~51,518 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 570 nodes · 767 edges · 57 communities (50 shown, 7 thin omitted)
...
4. `db` - 14 edges
5. `Tables` - 14 edges
6. `API Specification — EduVerify` - 14 edges
7. `users` - 13 edges
...
Cohesion: 0.08
Nodes (25): dependencies, bcrypt, cors, dotenv, drizzle-orm, express, @google/genai, jsonwebtoken (+17 more)

### Community 6 - "Drizzle ORM Schema Relations"
Cohesion: 0.06
Nodes (60): db, pool, env, required, commentLikes, comments, commentsRelations, courseEnrollments (+52 more)
...
Cohesion: 0.23
Nodes (9): subscriptions, ALLOWED_TYPES, uploadAvatar, uploadBanner, avatarUrl(), bannerUrl(), formatUser(), router (+1 more)
...
Cohesion: 0.20
Nodes (10): Adminer service (docker-compose), MySQL 8 service (docker-compose), verifyToken auth middleware, Client side (Login.jsx — unchanged), Google OAuth Flow, Migration change, requireRol role guard helper, Server side (`routes/auth.js`) (+2 more)
...
Cohesion: 0.18
Nodes (11): premium view (PasarelaPrueba.jsx), Session storage change, /api/premium endpoints, JWT payload shape, Login, Register, Traditional Auth Flow, Phase 10 - Cleanup (+3 more)
...
## Knowledge Gaps
- **284 isolated node(s):** `name`, `version`, `type`, `dev`, `start` (+279 more)
...
- **Why does `API Specification — EduVerify` connect `Community 27` to `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 41`, `Community 42`, `Community 55`, `Community 28`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `users table` connect `DB Schema & Backend Tables` to `Community 32`, `Community 39`, `Videos Backend Module`, `Registro Component`, `Community 30`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Phase 1 - Auth` connect `Videos Backend Module` to `Community 32`, `Registro Component`, `Community 30`, `Frontend Views (vista state)`?**
